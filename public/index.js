const host = "/";
const show = document.querySelector(".video-data");
const downloadButton = document.getElementById("get-video-info-btn");
const hiddenElement = document.getElementById("lo");
  ...
  .addEventListener("click", function () {
    ...
    fetch(host + "videoInfo?videoURL=" + videoURL)
      ...
      .then(function (data) {
        ...
        // Hide the hiddenElement when data is received
        hiddenElement.style.display = "none";
      })
      .catch(function (error) {
        alert("Something went wrong");
        // Hide the hiddenElement if an error occurs
        hiddenElement.style.display = "none";
      });
  });
